...
\node (cpu1) at (6.25, 1.5) [draw, thick, align=center, minimum width=0.30cm, minimum height=0.20cm] {\tiny{CPU}};
\node (cputemp1) at (6.25, 2.75) [draw, thick, align=center, circle, fill=yellow, inner sep=0.5pt] {$T^1_\text{CPU}$};
\draw[-] (cpu1) -- (cputemp1);

\node (psu1) at (3.75, 1.5) [draw, thick, align=center, minimum width=0.30cm, minimum height=0.20cm] {\tiny{PSU}};
\node (pc1) at (3.75, 2.75) [draw, thick, align=center, circle, fill=yellow, inner sep=0.5pt] {$P_\text{s}^1$};
\draw[] (psu1) -- (pc1);
